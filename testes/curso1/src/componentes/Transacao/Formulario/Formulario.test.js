...
test('Deve selecionar se o tipo de transação é depósito ou transferência', () => {
  render(<Formulario />);
  const seletor = screen.getByTestId('select-opcoes');
  ...
  userEvent.selectOptions(seletor, 'Transferência');
